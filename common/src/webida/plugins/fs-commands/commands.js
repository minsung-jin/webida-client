...
define([
    ...
    function OpenWithCodeEditorCommand(id) {
        OpenWithCodeEditorCommand.id = id;
    }
    genetic.inherits(OpenWithCodeEditorCommand, Command, {
        execute : function () {
            return new Promise(function (resolve) {
                var paths = wv.getSelectedPaths();
                if (paths && paths.length > 0) {
    ...
    return {
        ...
        OpenWithCodeEditorCommand: OpenWithCodeEditorCommand,
